...
ALTER TABLE orders ADD COLUMN IF NOT EXISTS details_json JSON;
ALTER TABLE evaluations ADD COLUMN IF NOT EXISTS wrong_assumption VARCHAR;
ALTER TABLE evaluations ADD COLUMN IF NOT EXISTS prompt_version VARCHAR;
